  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <center>Data Perangkat Kampung Holtekamp</center>
      </h1>
    </section>
          ...
          <div class="box">
            <div class="box-header">
              <button type="button" class="btn btn-sm btn-primary pull-right" data-toggle="modal" data-target="#modal-info">
                <i class="fa fa-plus"> Perangkat Kampung</i> 
              </button>
              <h3 class="box-title">Tabel Perangkat Kampung</h3>
            </div>
            <!-- /.box-header -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title">Form Tambah Data Perangkat Kampung</h3>
      </div>
